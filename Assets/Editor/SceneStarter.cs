...
public class NewMonoBehaviourScript
{
	...
	static NewMonoBehaviourScript()
	{
		EditorApplication.playModeStateChanged += PlayModeChanaged;
	}

	static void PlayModeChanaged(PlayModeStateChange state)
	{
	...
	[MenuItem("SceneStarter/시작 씬부터 시작")]
	...
	[MenuItem("SceneStarter/현재 씬부터 시작")]
